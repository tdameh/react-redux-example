/***
Note: This code is from https://github.com/robmclarty/paginated-redux
I edited it to resolve some issues related to sort by a nested element
***/
...
const paginated = (
  ...
  return (state = initialState, action) => {
    ...
    switch (action.type) {
      ...
      // list changing form.
      case FILTER: {
        const newCache = sortedList(
          by,
          order,
          filteredList(action.filter, list)
        );
